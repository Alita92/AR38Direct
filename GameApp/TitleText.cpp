...
void TitleText::Start()
{
	...
	titleScott_->GetTransform()->SetLocalPosition({ 500.0f, -330.0f, 100.0f });
//	titleScott_->SetOrder(10);
	...
	titleContinue_->GetTransform()->SetLocalPosition({ -500.0f, -130.0f, 100.0f });
	...
	titleNewGame_->GetTransform()->SetLocalPosition({ -500.0f, -60.0f, 100.0f });
