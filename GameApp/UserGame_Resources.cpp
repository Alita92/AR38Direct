...
void UserGame::ResourcesLoad()
{
...

	{
		...
		BlendInfo.RenderTarget[0].BlendEnable = true; // 블렌드 사용 여부.. 당연히 True
		BlendInfo.RenderTarget[0].RenderTargetWriteMask = D3D11_COLOR_WRITE_ENABLE_ALL; // 설정해준 값의 색상만 블랜드를 실시.. ALL 로 해서 모두 연산
